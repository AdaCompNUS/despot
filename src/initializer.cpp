...
Initializer::Initializer(string lower_bounds_str, string base_lower_bounds_str,
...
World* Initializer::InitializeWorld(std::string& world_type, DSPOMDP* model,
...
World* Initializer::InitializePOMDPWorld(string& world_type, DSPOMDP *model,
		option::Option* options) {
...
option::Option* Initializer::InitializeParamers(int argc, char *argv[],
...
Solver *Initializer::InitializeSolver(DSPOMDP *model, Belief* belief,
...
void Initializer::OptionParse(option::Option *options, int &num_runs,
...
void Initializer::DisplayParameters(option::Option *options, DSPOMDP *model) {
