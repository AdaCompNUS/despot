...
const option::Descriptor usage[] =
	{ { E_HELP, 0, "", "help", option::Arg::None, "  \t--help\tPrint usage and exit." },
		...
		// { E_EVALUATOR, 0, "", "evaluator", option::Arg::Required, "  \t--evaluator <arg>  \tUse IPPC server or a POMDP model as the evaluator." },
		// { E_DEFAULT_ACTION, 0, "", "default-action", option::Arg::Required, "  \t--default-action <arg>  \tType of default action to use. (default none)." },
		{ E_LBTYPE, 0, "l", "lbtype", option::Arg::Required, "-l <arg>  \t--lbtype <arg>  \tLower bound strategy." },
		{ E_BLBTYPE, 0, "", "blbtype", option::Arg::Required, "  \t--blbtype <arg>  \tBase lower bound." },
		{ E_UBTYPE, 0, "u", "ubtype", option::Arg::Required, "-u <arg>  \t--ubtype <arg>  \tUpper bound strategy." },
		{ E_BUBTYPE, 0, "", "bubtype", option::Arg::Required, "  \t--bubtype <arg>  \tBase upper bound." },
