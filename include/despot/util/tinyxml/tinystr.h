...
/*
 ...
 Only the member funcs relevant to the TinyXML project have been implemented.
...
public:
	...
	/*	func to reserve a big amount of data when we know we'll need it. Be aware that this
	 func DOES NOT clear the content of the TiXmlString if any exists.
	 */
