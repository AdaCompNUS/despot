...
public:
  MyEvaluator(string lower_bound_str, 
			string base_lower_bound_str,
			string upper_bound_str,
			string base_upper_bound_str) : Evaluator(lower_bound_str,
...
int main(int argc, char* argv[]) {
	return MyEvaluator("w/o base lower bounds: TRIVIAL; with base lower bounds: RANDOM, SHR, MODE-MDP, MODE-SP, MAJORITY-MDP, MAJORITY-SP (default to MODE-MDP)",
			"TRIVIAL (default)",
